    ...
    <div className="page-shell min-h-screen">
      ...
      <main className="pb-28 pt-[74px]">
        ...
        <section className="mx-auto max-w-[1500px] px-4 py-16 md:px-8 md:py-24" aria-labelledby="selection-results">
          ...
          <div className="grid grid-cols-1 gap-x-4 gap-y-10 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">{albums.map((album) => <AlbumCard key={album.id} album={album} headingLevel={3} />)}</div>
        </section>
