  ...
  return (
    <main className="flex min-h-[70vh] items-center justify-center px-4 py-24 text-center">
      <div>
        ...
        <SignedTitle className="mt-5 font-[var(--font-editorial)] text-5xl font-normal md:text-7xl">{locale === "fr" ? "Le catalogue est momentanément indisponible." : "The catalogue is temporarily unavailable."}</SignedTitle>
