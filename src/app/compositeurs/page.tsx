...
export async function generateMetadata({ searchParams }: ComposersPageProps): Promise<Metadata> {
  ...
  return buildMetadata({
    ...
    description: locale === "fr"
      ? `Découvrez les ${CANONICAL_COMPOSER_PROFILE_COUNT} compositeurs et collectifs Parigo, leurs biographies et leur discographie Harvest.`
      : `Discover Parigo's ${CANONICAL_COMPOSER_PROFILE_COUNT} composers and collectives, their biographies and Harvest discography.`,
    index: !params.q,
  });
}
