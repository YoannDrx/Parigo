...
export default function AboutPage() {
  ...
  const paragraphs = locale === "fr"
    ...
    : [
        "Founded in 2010, Parigo is an independent music library that helps image and sound professionals find the ideal music for their projects. From the outset, we have chosen to put people at the heart of our work, convinced that no algorithm can ever replace the sensitivity of a genuine conversation.",
