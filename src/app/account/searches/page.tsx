...
export default function SavedSearchesPage() {
  ...
  return <div className="account-page">
    <div className="account-page__header mb-9 flex flex-wrap items-end justify-between gap-5">
