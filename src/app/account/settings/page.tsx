  ...
  return (
    <div className="account-page space-y-8">
      ...
      <motion.div
        ...
        className="parigo-frame border border-[var(--line)] bg-[var(--surface)] p-6"
      >
      ...
      <motion.div
        ...
        className="parigo-frame relative overflow-hidden border border-[var(--line-strong)] bg-[var(--surface)]"
      >
