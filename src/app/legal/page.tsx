...
export default function LegalPage() {
  ...
  const sections = locale === "fr" ? [
    ...
    { title: "Conception & développement", content: <p>Webmaster : <strong>YoDev</strong> · <a href="https://www.yodev.fr/" target="_blank" rel="noopener noreferrer">yodev.fr</a> · <a href="mailto:yoann.andrieux@gmail.com">yoann.andrieux@gmail.com</a>.</p> },
    ...
    { title: "Design & development", content: <p>Webmaster: <strong>YoDev</strong> · <a href="https://www.yodev.fr/" target="_blank" rel="noopener noreferrer">yodev.fr</a> · <a href="mailto:yoann.andrieux@gmail.com">yoann.andrieux@gmail.com</a>.</p> },
