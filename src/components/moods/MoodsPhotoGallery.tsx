      ...
      {activeCollection === "real" ? (
        <>
          <div className="mb-6 rounded-[14px] border border-[#d3df63]/25 bg-[#d3df63]/8 p-4 text-sm leading-6 text-[#c9c2b6] sm:p-5">
            <strong className="font-medium text-[#edf78b]">Jalons d’étalonnage :</strong> {versionCounts.v2} images V2 et {versionCounts.v3} image{versionCounts.v3 > 1 ? "s" : ""} V3 sont disponibles. La suite de la campagne reste volontairement en attente de validation de la fidélité documentaire.
          </div>
