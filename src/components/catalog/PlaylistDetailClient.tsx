  ...
  return (
    <div className="page-shell flex min-h-screen flex-col">
      ...
      <main className="flex-1 pb-[var(--space-page-end)] pt-[var(--space-contextual-back-page-top)]">
        <div className="mx-auto max-w-[1500px] px-[var(--space-page-gutter)]"><ContextualBackLink href={localizedPath("/playlists")} className="hover:text-[var(--foreground)]"><ArrowLeft size={17} /> {t("common.back")}</ContextualBackLink></div>
        <section className="editorial-detail-hero relative mx-auto grid max-w-[1500px] items-center gap-[var(--space-block-gap)] overflow-hidden px-[var(--space-page-gutter)] pb-0 pt-[var(--space-contextual-back-gap)] lg:grid-cols-[minmax(300px,420px)_minmax(0,1fr)]">
