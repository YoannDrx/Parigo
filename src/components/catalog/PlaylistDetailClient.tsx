      ...
      <main className="flex-1 pb-[var(--space-page-end)] pt-[88px]">
        ...
        <section className="editorial-detail-hero relative mx-auto grid max-w-[1500px] items-center gap-[var(--space-block-gap)] overflow-hidden px-[var(--space-page-gutter)] pb-0 pt-[var(--space-section-y)] lg:grid-cols-[minmax(300px,420px)_minmax(0,1fr)]">
          ...
          <div className="flex max-w-3xl animate-[fade-in_.3s_ease-out_both] flex-col justify-center">
            ...
            <div className="mt-8 flex flex-wrap gap-6 border-y border-[var(--line)] py-5 font-mono text-[.65rem] uppercase tracking-[.1em] text-[var(--text-muted)]"><span className="flex items-center gap-2"><Music size={14} />{playlist.trackCount} {playlist.trackCount === 1 ? t("catalog.track") : t("catalog.tracks")}</span><span className="flex items-center gap-2"><Clock size={14} />{formatDuration(playlist.totalDuration)}</span></div>
