...
export function PlaylistDetailClient({ playlist }: { playlist: PlaylistDetail }) {
  ...
  return (
    <div className="page-shell flex min-h-screen flex-col">
      <Header />
      <main className="flex-1 pb-[var(--space-section-y-large)] pt-[88px]">
        ...
        <section className="editorial-detail-hero relative mx-auto grid max-w-[1500px] items-center gap-[var(--space-block-gap)] overflow-hidden px-[var(--space-page-gutter)] py-[var(--space-section-y)] lg:grid-cols-[minmax(300px,420px)_minmax(0,1fr)]">
