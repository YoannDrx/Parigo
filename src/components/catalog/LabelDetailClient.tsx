  ...
  return (
    <div className="page-shell flex min-h-screen flex-col">
      ...
      <main className="flex-1 pb-28 pt-[70px]">
        <div className="mx-auto max-w-[1700px] px-4 py-6 lg:px-8"><ContextualBackLink href={localizedPath("/labels")} className="inline-flex min-h-11 items-center gap-2 text-sm text-[var(--text-muted)]"><ArrowLeft size={17} /> {t("common.labels")}</ContextualBackLink></div>
