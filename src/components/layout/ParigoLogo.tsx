...
export function ParigoLogo({ className, monochrome = false }: ParigoLogoProps) {
  const accentStyle = monochrome ? { fill: "currentColor" } : undefined;
  return (
    <span className={cn("parigo-logo", styles.root, className)} aria-hidden="true">
      <svg viewBox="0 0 995.86 284.69" focusable="false" role="presentation">
        ...
        <path style={accentStyle} className="parigo-logo__corner parigo-logo__corner--bottom" d="M75.17 261.83h134.98v22.86H75.17C33.72 284.69 0 250.98 0 209.53V50.33h22.91l-.04 159.2c0 28.84 23.46 52.3 52.3 52.3Z" />
        <rect style={accentStyle} className="parigo-logo__extension parigo-logo__extension--bottom" x="75.17" y="261.83" width="134.98" height="22.86" />
        <path style={accentStyle} className="parigo-logo__go" d="M667.04 163.37h42.2v.89c0 22.43-20.88 34.42-39.75 34.42-25.76 0-46.64-25.54-46.64-56.63s20.88-57.29 46.64-57.29c16.21 0 30.2 6.44 40.86 23.54l27.32-29.98c-15.99-19.32-38.42-31.31-70.62-31.31-51.52 0-89.27 42.41-89.27 95.05s39.97 95.05 89.27 95.05c53.52 0 84.61-40.2 84.61-73.73v-32.2h-84.61v32.2Zm278.6-21.32c0 53.52-41.75 95.05-92.38 95.05s-92.38-41.53-92.38-95.05S802.63 47 853.26 47s92.38 41.53 92.38 95.05Zm-45.08 0c0-27.32-15.1-54.85-47.3-54.85s-47.3 27.54-47.3 54.85 15.1 54.85 47.3 54.85 47.3-27.54 47.3-54.85Z" />
      </svg>
    </span>
  );
}
