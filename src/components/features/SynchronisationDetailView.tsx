    ...
    <div className="page-shell">
      ...
      <main className="px-4 pb-24 pt-28 md:px-8 md:pb-36 md:pt-32">
        <div className="mx-auto max-w-[1440px]">
          <Link href="/synchronisations" className="inline-flex min-h-11 items-center gap-2 text-sm font-semibold text-[var(--text-muted)] transition hover:text-[var(--signal-strong)]"><ArrowLeft size={16} />{locale === "fr" ? "Toutes les synchronisations" : "All synchronisations"}</Link>
          <div className="mt-9 grid gap-7 lg:grid-cols-12 lg:items-start">
            ...
            <aside className="flex min-h-full flex-col rounded-[1.15rem] border border-[var(--line)] bg-[var(--surface)] p-6 lg:col-span-4 lg:p-8">
              <p className="eyebrow text-[var(--signal-strong)]">Parigo / Synchronisation</p>
