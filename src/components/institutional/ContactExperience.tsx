    ...
    <InstitutionalShell title={title} intro={intro}>
      <section className="bg-[var(--surface-soft)] px-4 py-16 md:px-8 md:py-24">
        <div className="mx-auto grid max-w-[1500px] gap-6 md:grid-cols-12">
          <div className="parigo-frame h-fit border border-[var(--line)] bg-[var(--surface)] p-6 md:col-span-4 md:p-8">
            {isLicenceRequest ? (
            ...
            <address className="mt-6 not-italic text-lg leading-relaxed text-[var(--text-muted)]">
              Paris, France<br />
              <a href="mailto:info@parigomusic.com" className="break-all underline decoration-[var(--signal-strong)]/35 underline-offset-4">info@parigomusic.com</a>
            </address>
