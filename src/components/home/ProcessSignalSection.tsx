  ...
  return (
    <section id="process" ref={sectionRef} className="relative px-4 py-16 md:px-8 md:py-32">
      <div className="mx-auto max-w-[1580px]">
        <div className="mb-8 grid gap-5 md:mb-10 md:grid-cols-12 md:items-end md:gap-6"><div className="md:col-span-7"><SignedTitle as="h2" className="text-[clamp(2.8rem,5vw,5.5rem)] leading-[.91] text-[var(--foreground)]">{locale === "fr" ? "Du brief à la sélection." : "From brief to selection."}</SignedTitle></div><p className="max-w-md text-sm leading-6 text-[var(--text-muted)] md:col-span-3 md:col-start-10">{locale === "fr" ? "Un parcours direct, pensé pour garder l’intuition créative au centre." : "A direct workflow designed to keep creative intuition at the centre."}</p></div>
