...
/*
 * Adapted from React Bits (LiquidEther, TS-TW variant).
...
`;
    ...
    vec3 ink = lightMode ? mix(c, chroma, 0.18) : c;
    float coverage = lightMode ? smoothstep(0.01, 0.3, lenv) : lenv;
    vec3 outRGB = mix(bgColor.rgb, ink, coverage);
    float outA = mix(bgColor.a, 1.0, coverage);
