...
/*
 * Adapted from React Bits (FloatingLines, JS-CSS variant) with project-local TypeScript types.
 * Copyright (c) 2026 David Haz.
 * Licensed under the React Bits MIT + Commons Clause License Condition v1.0.
 * Source: https://reactbits.dev/backgrounds/floating-lines
 */
...
export default function FloatingLines({
  ...
  useEffect(() => {
    ...
    // The hero content sits above the decorative canvas. Listening on the hero
    // preserves the original cursor interaction without intercepting its controls.
    const interactionSurface = container.closest<HTMLElement>('.home-hero') ?? renderer.domElement;
