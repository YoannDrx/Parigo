...
/*
 * Adapted from React Bits (GhostFibers, TS-TW variant).
 * Copyright (c) 2026 David Haz.
 * Licensed under the React Bits MIT + Commons Clause License Condition v1.0.
 * Source: https://reactbits.dev/backgrounds/ghost-fibers
 */
...
void main() {
  ...
  if (uLightMode > 0.5) {
    ...
    vec3 fiberInk = mix(backdrop, uLineColor, 0.92);
    vec3 airColor = mix(backdrop, uGlowColor, 0.32);
