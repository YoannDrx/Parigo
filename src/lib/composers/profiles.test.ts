...
describe("canonical composer registry", () => {
  ...
  it("publishes the supplied biographies verbatim and records portrait overrides", () => {
    ...
    for (const slug of ["aeon-seven", "after-in-paris", "arom", "bruno-hovart", "daniel-amozig", "grand-david", "jb-hanak", "laurent-dury", "loic-laporte", "minimatic", "mister-modo", "modulhater", "of-ivory-and-horn", "patrice-dambrine", "stan-galouo", "the-architect", "the-well-quartet", "thierry-los", "ugly-mac-beer", "xavier-sibre"]) {
