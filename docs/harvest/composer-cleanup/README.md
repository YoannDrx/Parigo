...
- `audit-AAAA-MM-JJ.json` : modèle exhaustif `profil → album → œuvre principale → variantes`, incluant les contributeurs hors des 55 profils.
...
- `summary-AAAA-MM-JJ.json` : résumé daté des 55 profils publics.
