...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: "/label-parigo", destination: "/notre-label", permanent: true },
      { source: "/en/label-parigo", destination: "/en/notre-label", permanent: true },
      { source: "/sorties-parigo", destination: "/notre-label", permanent: true },
      { source: "/en/sorties-parigo", destination: "/en/notre-label", permanent: true },
