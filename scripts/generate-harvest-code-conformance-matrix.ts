...
const PAYLOADS: Record<string, string> = {
  ...
  updatemember: "MemberAccount{ID, FirstName, LastName, Email, Username, Company, Country, Production, SubProduction, Position, Address1, Address2, Suburb, State, Postcode, Phone, FileFormat, Website, TermsAccept, PrivacyAccept, SearchFormat, SearchSort, Attributes, Status}",
  ...
  getsharemusicurl: "FromMemberToken, ObjectIdentifier, ObjectType=Playlist, Users[{Username, Type, ShareType=Sync, AllowDownload, AllowFollow, AllowSave, AllowShare, AllowCollaboration, AllowEdit}]",
  ...
  addtrackmembercomment: "trackid, tagname",
  updatetrackmembercomment: "tagid, trackid, tagname",
...
const ASSESSMENTS: Record<string, [string, string]> = {
  ...
  membersubscribe: ["correctif-parigo-confirme", "La source relue est SubscribeNewsletter; la bascule true/false a été vérifiée en live puis restaurée."],
  sendpasswordresetemail: ["contrat-corrige-configuration-requise", "Parigo envoie le contrat corrigé Username/Email; Harvest répond encore Failed, Required route not found. L'UI signale l'indisponibilité sans annoncer un envoi."],
  getsharemusicurl: ["contrat-corrige-configuration-requise", "Le payload Users[] fourni par Harvest est implémenté. Le compte Parigo répond encore Error.Code=3, No route configuration found; l'UI et la route restent désactivées par configuration."],
  ...
  getinvitedmembertoken: ["obsolète-pour-partage", "Harvest confirme que cette étape ne doit plus être appelée séparément; Parigo l'a retirée du parcours de partage."],
  ...
  addtrackmembercomment: ["correctif-parigo-confirme", "Parigo envoie désormais trackid/tagname en minuscules et vérifie la création par relecture."],
  updatetrackmembercomment: ["correctif-parigo-confirme", "Parigo envoie désormais tagid/trackid/tagname et vérifie la modification par relecture."],
...
const LIVE_EVIDENCE: Record<string, string> = {
  ...
  sendpasswordresetemail: "exécuté via le BFF le 04/08/2026: HTTP 200, erreur logique Failed, Required route not found; aucun envoi annoncé",
  ...
  membersubscribe: "exécuté et relu le 04/08/2026: SubscribeNewsletter basculé puis restauré",
  suggestmemberplaylisttracks: "exécuté: HTTP 200, Error.Code=3, capacité non activée",
  getsharemusicurl: "payload Users[] exécuté le 04/08/2026: HTTP 200, Error.Code=3, No route configuration found; aucune URL créée",
