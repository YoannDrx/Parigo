...
const profiles: ProfileSource[] = [
  ...
  { slug: "laurent-dury", name: "Laurent Dury", kind: "person", localImageFile: "laurent_dury.png", cardImageTransform: { extract: { left: 300, top: 220, width: 760, height: 760 }, position: "center" }, detailImageTransform: { extract: { left: 300, top: 220, width: 760, height: 760 } }, aliases: ["Laurent Dury"], rightHolderIds: ["57738dbd2a803c69"] },
  ...
  { slug: "kokane", name: "Kokane", kind: "person", localImageFile: "kokane.jpg", cardImageTransform: { extract: { left: 3, top: 3, width: 474, height: 714 }, position: "center" }, detailImageTransform: { extract: { left: 3, top: 3, width: 474, height: 714 } }, cardCrop: { objectPosition: "center", fit: "contain" }, aliases: ["Kokane"] },
  ...
  { slug: "nsdos", name: "NSDOS", kind: "person", localImageFile: "nsdos.jpg", cardImageTransform: { position: "north" }, cardCrop: { objectPosition: "center", fit: "contain" }, aliases: ["Brice Torres", "Torres Brice", "NSDOS"], rightHolderIds: ["c1b1226224708ecc"] },
  ...
  { slug: "loic-laporte", name: "Loïc Laporte", kind: "person", localImageFile: "loic_laporte.webp", cardImageTransform: { fit: "contain", position: "center", background: "#000000" }, cardCrop: { objectPosition: "center", fit: "contain" }, aliases: ["Loic Laporte", "Loïc Laporte"] },
