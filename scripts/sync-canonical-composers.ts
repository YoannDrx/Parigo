...
const profiles: ProfileSource[] = [
  ...
  { slug: "kokane", name: "Kokane", kind: "person", localImageFile: "kokane.jpg", cardImageTransform: { extract: { left: 3, top: 3, width: 474, height: 714 }, position: "center" }, detailImageTransform: { extract: { left: 3, top: 3, width: 474, height: 714 } }, cardCrop: { objectPosition: "50% 18%", fit: "cover" }, aliases: ["Kokane"] },
  ...
  { slug: "loic-laporte", name: "Loïc Laporte", kind: "person", localImageFile: "loic_laporte.webp", cardImageTransform: { fit: "cover", position: "north" }, cardCrop: { objectPosition: "50% 14%", fit: "cover" }, aliases: ["Loic Laporte", "Loïc Laporte"] },
