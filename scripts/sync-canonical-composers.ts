...
const profiles: ProfileSource[] = [
  ...
  { slug: "nsdos", name: "NSDOS", kind: "person", localImageFile: "nsdos.jpg", cardImageTransform: { position: "north" }, aliases: ["Brice Torres", "Torres Brice", "NSDOS"], rightHolderIds: ["c1b1226224708ecc"] },
  ...
  { slug: "of-ivory-and-horn", name: "Of Ivory & Horn", kind: "group", localImageFile: "of_ivory_and_horn.jpg", aliases: ["Of Ivory And Horn", "Of Ivory & Horn"], rightHolderIds: ["11b8a4a0e2cfbb2e"], legacySlugs: ["of-ivory-horn"] },
  { slug: "mister-modo", name: "Mister Modo", kind: "person", localImageFile: "mister_modo.jpg", aliases: ["Mister Modo"], rightHolderIds: ["64975cc9240b0bba"] },
